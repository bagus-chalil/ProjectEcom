          ...
          <div class="portfolio-info">
            ...
            <form>
              <div class="mb-3">
                ...
                <!--Form Hidden -->
                <input type="hidden" class="form-control" id="event_id" aria-describedby="emailHelp"
                value="<?= $detailbayar['event_id'] ?>">
                <input type="hidden" class="form-control" id="judul" aria-describedby="emailHelp"
                value="<?= $detailbayar['judul'] ?>">
                <input type="hidden" class="form-control" id="harga" aria-describedby="emailHelp"
                value="<?= $detailbayar['harga'] ?>">
                <input type="hidden" class="form-control" id="tgl_event" aria-describedby="emailHelp"
                value="<?= $detailbayar['tgl_event'] ?>">
                <!-- End Form hidden -->
...
<script type="text/javascript">
              ...
              $.ajax({
                ...
                data : {event_id: event_id, judul: judul, harga: harga, tgl_event: tgl_event, email: email, name: name, telephone :telephone},
                cache: false,
